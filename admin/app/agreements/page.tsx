                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="hidden px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 sm:table-cell sm:px-6">Booking #</th>
                      <th className="hidden px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 md:table-cell sm:px-6">Dates</th>
                      <th className="hidden px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 md:table-cell sm:px-6">Signed</th>
                      <th className="hidden px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 lg:table-cell sm:px-6">Signature</th>
                    ...
                    {filtered.map((agreement) => (
                      <tr key={agreement.id} className="hover:bg-gray-50">
                        <td className="whitespace-nowrap px-4 py-4 sm:px-6">
                          ...
                          <div className="text-xs text-gray-400 sm:hidden">{agreement.reservation?.booking_number}</div>
                        </td>
                        <td className="hidden whitespace-nowrap px-6 py-4 text-sm font-medium text-forest sm:table-cell">
